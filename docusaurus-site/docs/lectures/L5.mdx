...
<span class="redbold underline">Superposition</span>: (right and left)
$$
\displaystyle \frac{{\color{red}{\underline{l=r}}} \lor C \;\;\; {\color{red}{\underline{s[l] = t}}} \lor D}{s[r]=t \lor C \lor D}(Sup),\;\;\;\;\;\;
\frac{{\color{red}{\underline{l=r}}} \lor C \;\;\; {\color{red}{\underline{s[l]\neq t}}} \lor D}{s[r] \neq t \lor C \lor D}(Sup),
$$
...
$$
\displaystyle\frac{{\color{red}{\underline{l=r}}} \lor C \;\;\; {\color{red}{\underline{s[l]=t}}} \lor D}{s[r]=t\lor C \lor D}(Sup),\;\;\;\;\;\;
\displaystyle\frac{{\color{red}{\underline{l=r}}} \lor C \;\;\; {\color{red}{\underline{s[l]\neq t}}} \lor D}{s[r]\neq t\lor C \lor D}(Sup),
$$
